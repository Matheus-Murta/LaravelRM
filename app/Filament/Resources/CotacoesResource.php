...
use App\Filament\Resources\CotacoesResource\Pages;
use App\Filament\Resources\CotacoesResource\RelationManagers;
...
class CotacoesResource extends Resource
{
    protected static ?string $model = Cotacoes::class;
    ...
    {
        return [
            'index' => Pages\ManageCotacoes::route('/'),
        ];
    }
}
